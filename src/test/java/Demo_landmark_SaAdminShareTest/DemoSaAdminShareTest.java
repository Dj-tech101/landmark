...
public class DemoSaAdminShareTest extends baseclass {
	...
	public void SharingFunctionTest() throws InterruptedException, IOException {
		...
		myEvent.getSearchFunction("SHARE TEST123");
	...
	@Test(priority = 1)
	public void validateSearchSuspendedStatusIfNodata() {
		shareEvent = new SharingEvent();
		validateSearchFunction(shareEvent);

		extenttest.info("validate the Suspended message  ");

		if (shareEvent.getNoDataFoundMessage().contains("NODATA")) {
