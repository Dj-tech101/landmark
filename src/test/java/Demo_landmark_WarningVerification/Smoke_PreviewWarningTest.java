...
public class Smoke_PreviewWarningTest extends baseclass {
	...
	public void WarnigMessagePriviewTest() throws InterruptedException, IOException {
		...
		validateShareWarning(designPage);
