...
public class Smoke_AgeGateNodeWarningTest extends baseclass {
	...
	public void WarnigMessageAgeNodeTest() throws InterruptedException, IOException {
		...
		validateAgeNodeWarning(designPage);
...
//	}
	...
	private void validateAgeNodeWarning(boothDesignPage designPage2) throws InterruptedException {
		// TODO Auto-generated method stub
		extenttest.info("drag Age Gate in Boothdesign");

		designPage.dragAndDropAgeGateNode();
	}

	private void validateCustomeInsertWarning(boothDesignPage designPage2) throws InterruptedException {
		// TODO Auto-generated method stub
		extenttest.info("drag custome Insert in Boothdesign");

		designPage.dragAndDropCustomeInsertNode();

	}

	private void validateShareWarning(boothDesignPage designPage) throws InterruptedException {

		extenttest.info("drag Share in Boothdesign");
