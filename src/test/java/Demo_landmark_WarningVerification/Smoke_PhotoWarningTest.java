...
public class Smoke_PhotoWarningTest extends baseclass {
	...
	public void WarnigMessagePhotoTest() throws InterruptedException, IOException {
		...
		validatephotoWarning(designPage);
...
//	}
	...
	private void validatephotoWarning(boothDesignPage designPage) {
...
//	}
	...
	private void fillEventDetails(eventDetailsPage eventDetails2) throws InterruptedException {
		...
		EventnameUse = "PhotoWarningTest" + String.valueOf(number);
