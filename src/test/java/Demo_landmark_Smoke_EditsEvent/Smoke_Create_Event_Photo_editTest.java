...
//
	...
	public void Create_Event_Photo_copyTest() throws InterruptedException, IOException {
		...
		String name = "Test paylater for photo " + String.valueOf(number);
		...
		controlAction.takeScreenshot("test photo edit event");
		
		org.testng.Assert.assertEquals("photo", designPage.getPhotoNodeText());
